...
{
    std::cout << "ChatBot c'tor" << std::endl;
...
ChatBot::~ChatBot()
{
    std::cout << "ChatBot d'tor" << std::endl;
...
ChatBot& ChatBot::operator=(const ChatBot &source) {
    std::cout << "ChatBot copy assignment c'tor" << std::endl;
...
ChatBot& ChatBot::operator=(ChatBot &&source) {
  	std::cout << "ChatBot move assignment c'tor" << std::endl;
